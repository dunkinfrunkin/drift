...
// GenerateCreateSQL produces CREATE TABLE SQL for an entire schema snapshot.
func GenerateCreateSQL(snap *SchemaSnapshot) string {
	var b strings.Builder
	b.WriteString("-- Baseline SQL generated by drift\n\n")

	for _, t := range snap.Tables {
		b.WriteString(generateCreateTableSQL(t))
		b.WriteString(";\n\n")
	}
